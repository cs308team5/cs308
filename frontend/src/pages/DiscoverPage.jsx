...
const ProductGridCard = ({ product, isWishlisted, onOpen, onAddToCart, onToggleWishlist }) => {
...
const ProductListRow = ({ product, isWishlisted, onOpen, onAddToCart, onToggleWishlist }) => {
  const stock = getStockStatus(product.stock_quantity);
  const hasRatings = product.ratingCount > 0;
  const inStock = product.stock_quantity > 0;
  const popularityLabel = hasRatings
